...
contract OmegaPiVoting is Ownable {
    using SafeMath for uint256;

    // Mapping of user votes
    mapping (address => uint256) public votes;

    // Mapping of user delegations
    ...
    // Event for delegating votes
    event Delegate(address indexed user, address indexed delegate);
    ...
    function delegate(address delegate) public {
        ...
        emit Delegate(msg.sender, delegate);
    }
}
